function [y,t] = uniporz(Rb,msg,fs)
%function [y,t] = uniporz(Rb,msg,fs)
%UNIPORZ  Señal banda base unipolar con  [0 1].
%       [y,t] = UNIPORZ(RB,MSG) y [y,t] = UNIPORZ(RB,MSG,FS)
%	Genera una señal unipolar con retorno a cero de velocidad 
%	RB bits por segundo, y frecuencia de muestreo, FS.  
%	Si MSG es un escalar, el mensaje se generará como una 
%	secuencia aleatoria de longitud MSG con Pr(0)=Pr(1)=0.5. 
%	Si MSG es un vector, debe contener sólo 0's and 1's. 
%	El valor deFS es por defecto 8192 Hz.

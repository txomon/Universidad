function handles2
%HANDLES2 - Current handles used by ZOOMTOOL.
%
...
% 28			xfactor
% 29			xmin inside current limits
% 30			xmax inside current limits
% 31			ymin inside current limits
% 32			ymax inside current limits
% 33			min(x)
% 34			max(x)
% 35			min(y)
% 36			max(y)

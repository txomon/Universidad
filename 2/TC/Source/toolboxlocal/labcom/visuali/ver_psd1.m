function ver_psd1 (x, t, fftpts, fre_visu, n_ite)
% function ver_psd1 (x, t, fftpts, fre_visu, n_ite)
% Función que visualiza gráficamente una señal y su desidad espectral de potencia.
...
if ((nargin==4)|(nargin==5))
	if (nargin==4)
        ...
        while (((indice+fftpts)<m)&(n_ite>0))
                ...
                set(handels(5),'XData',w(1:n)/(2*pi),'YData',psd);

function ver_psd2 (x, y, t, fftpts, fre_visu, n_ite)
% function ver_psd2 (x, y, t, fftpts, fre_visu, n_ite)
% Función que visualiza gráficamente dos señales y sus desidades espectrales.
...
if ((nargin==5)|(nargin==6))
	if (nargin==5)
        ...
        while (((indice+fftpts)<m)&(n_ite>0))
                ...
                set(handels_x(9), 'String',[tmp '(phase)'])
                ...
                set(handels_y(9), 'String',[tmp '(phase)'])

...
%   figure described by Pos to let the user interactively change the CIMPULSE
...
%   UserData property holds a CIMPULSE object.
%
...
%     stores the CIMPULSE data in the UserData property of the plot.
%
%     GUI('Rescale Plot') rescales the x and y axis of the plot to fit the data.
%
%   See also SIGGENDLG, CIMPULSE

% Jordan Rosenthal, 05-Nov-1999
%             Rev., 26-Oct-2000 Revised for name change to CIMPULSE
...
case 'Initialize'   
   ...
   Labels = {'Area:','Delay:'};
   Values = num2str( [Signal.Area; Signal.Delay] );
   Min = [-Inf; -Inf];
   Max = [Inf;  Inf];

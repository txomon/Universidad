...
%   figure described by Pos to let the user interactively change the CSINE
...
%   UserData property holds a CSINE object.
%
...
%     stores the CSINE data in the UserData property of the plot.
%
%     GUI('Rescale Plot') rescales the x and y axis of the plot to fit the data.
%
%   See also SIGGENDLG, CSINE

% Jordan Rosenthal, 05-Nov-1999
%             Rev., 26-Oct-2000 Revised for name change to CSINE

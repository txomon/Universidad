...
%STEM Overloaded STEM command for a UNITSAMPLE object
%   h = STEM(Signal) creates a STEM plot for the UNITSAMPLE object Signal.
...
%
%   See also UNITSAMPLE, FORMULASTRING
